...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2017 at 12:50 PM
...
-- Database: `qlbanhoa`
--
CREATE DATABASE IF NOT EXISTS `qlbanhoa` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `qlbanhoa`;
...
--
ALTER TABLE `hoa`
  ADD CONSTRAINT `fk_hoa_loaihoa` FOREIGN KEY (`maloai`) REFERENCES `loaihoa` (`Maloai`);
